...
/**
 * same code for MergeableHeapUnSortedInput
 ...
 */
public class MergeableHeapUnSortedDisjointInput extends MergeableHeap<Integer> {
    ...
    public MergeableHeap<Integer> union(MergeableHeap<Integer> linkedList2) {
        MergeableHeapUnSortedDisjointInput mergeableHeapSortedToUnion = (MergeableHeapUnSortedDisjointInput) linkedList2;
        Node<Integer> pointer1 = this.linkedList.getHead();
        Node<Integer> pointer2 = mergeableHeapSortedToUnion.getLinkedList().getHead();
        MergeableHeapUnSortedDisjointInput unionResult = new MergeableHeapUnSortedDisjointInput();
